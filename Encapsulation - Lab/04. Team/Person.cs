...
namespace PersonsInfo
{
    public class Person
    {
        ...
        public string FirstName
        {
            ...
            {
                if (value.Length < 3) 
                    throw new ArgumentException(ErrorMessages.INVALID_FIRST_NAME);
        ...
        public string LastName
        {
            ...
            {
                if (value.Length < 3) 
                    throw new ArgumentException(ErrorMessages.INVALID_LAST_NAME);
        ...
        public decimal Salary
        {
            ...
            {
                if (value < 650) 
                    throw new ArgumentException(ErrorMessages.INVALID_SALARY);
